...
namespace BodyBuilder.Application.Utilities.JWT {
    public class TokenCreate : ITokenCreate {
        ...
        public AccessToken CreateToken(User user) {
            ...
            var tokenExpireDate = DateTime.UtcNow.AddDays(Convert.ToInt32(_configuration["TokenOptions:AccessTokenExpiration"]));
            ...
            //userRoles
                claims.Add(new Claim(ClaimTypes.Role,user.Role.Id.ToString()));
